...
public final class LeqTest {

  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testBit")
  void testBit(final BitType a, final BitType b, final BitType e) { assertEquals(e, Leq.bit(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testU08")
  void testU08(final U08Type a, final U08Type b, final BitType e) { assertEquals(e, Leq.u08(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testU16")
  void testU16(final U16Type a, final U16Type b, final BitType e) { assertEquals(e, Leq.u16(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testU32")
  void testU32(final U32Type a, final U32Type b, final BitType e) { assertEquals(e, Leq.u32(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testU64")
  void testU64(final U64Type a, final U64Type b, final BitType e) { assertEquals(e, Leq.u64(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testI08")
  void testI08(final I08Type a, final I08Type b, final BitType e) { assertEquals(e, Leq.i08(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testI16")
  void testI16(final I16Type a, final I16Type b, final BitType e) { assertEquals(e, Leq.i16(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testI32")
  void testI32(final I32Type a, final I32Type b, final BitType e) { assertEquals(e, Leq.i32(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testI64")
  void testI64(final I64Type a, final I64Type b, final BitType e) { assertEquals(e, Leq.i64(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testF32")
  void testF32(final F32Type a, final F32Type b, final BitType e) { assertEquals(e, Leq.f32(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} leq {1} = {2}") @MethodSource("testF64")
  void testF64(final F64Type a, final F64Type b, final BitType e) { assertEquals(e, Leq.f64(a, b)); }
