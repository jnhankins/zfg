...
public final class XorTest {
  ...
  void testU08(final Bit a, final Bit b, final Bit e) { assertEquals(e, Xor.bit(a, b)); }
  ...
  static Stream<Arguments> testU08() {
    return Helper.u08(new int[][] {
      ...
      {0x0000000F, 0x000000FF, 0x000000F0},

      {0x000000F0, 0x00000000, 0x000000F0},
      {0x000000F0, 0x0000000F, 0x000000FF},
      {0x000000F0, 0x000000F0, 0x00000000},
      {0x000000F0, 0x000000FF, 0x0000000F},

      {0x000000FF, 0x00000000, 0x000000FF},
      {0x000000FF, 0x0000000F, 0x000000F0},
      {0x000000FF, 0x000000F0, 0x0000000F},
  ...
  static Stream<Arguments> testU16() {
    return Helper.u16(new int[][] {
      ...
      {0x0000000F, 0x0000FFFF, 0x0000FFF0},

      {0x0000F000, 0x00000000, 0x0000F000},
      {0x0000F000, 0x0000000F, 0x0000F00F},
      {0x0000F000, 0x0000F000, 0x00000000},
      {0x0000F000, 0x0000FFFF, 0x00000FFF},

      {0x0000FFFF, 0x00000000, 0x0000FFFF},
      {0x0000FFFF, 0x0000000F, 0x0000FFF0},
      {0x0000FFFF, 0x0000F000, 0x00000FFF},
  ...
  static Stream<Arguments> testU32() {
    return Helper.u32(new int[][] {
      ...
      {0x0000000F, 0xFFFFFFFF, 0xFFFFFFF0},

      {0xF0000000, 0x00000000, 0xF0000000},
      {0xF0000000, 0x0000000F, 0xF000000F},
      {0xF0000000, 0xF0000000, 0x00000000},
      {0xF0000000, 0xFFFFFFFF, 0x0FFFFFFF},

      {0xFFFFFFFF, 0x00000000, 0xFFFFFFFF},
      {0xFFFFFFFF, 0x0000000F, 0xFFFFFFF0},
      {0xFFFFFFFF, 0xF0000000, 0x0FFFFFFF},
  ...
  static Stream<Arguments> testU64() {
    return Helper.u64(new long[][] {
      ...
      {0x00000000_0000000FL, 0x00000000_0000000FL, 0x00000000_00000000L},
      {0x00000000_0000000FL, 0xF0000000_00000000L, 0xF0000000_0000000FL},
      {0x00000000_0000000FL, 0xFFFFFFFF_FFFFFFFFL, 0xFFFFFFFF_FFFFFFF0L},
      ...
      {0xF0000000_00000000L, 0xF0000000_00000000L, 0x00000000_00000000L},
      {0xF0000000_00000000L, 0xFFFFFFFF_FFFFFFFFL, 0x0FFFFFFF_FFFFFFFFL},

      {0xFFFFFFFF_FFFFFFFFL, 0x00000000_00000000L, 0xFFFFFFFF_FFFFFFFFL},
      {0xFFFFFFFF_FFFFFFFFL, 0x00000000_0000000FL, 0xFFFFFFFF_FFFFFFF0L},
      {0xFFFFFFFF_FFFFFFFFL, 0xF0000000_00000000L, 0x0FFFFFFF_FFFFFFFFL},
      {0xFFFFFFFF_FFFFFFFFL, 0xFFFFFFFF_FFFFFFFFL, 0x00000000_00000000L},
    });
  }
  ...
  static Stream<Arguments> testI08() {
    return Helper.i08(new int[][] {
      ...
      {0xFFFFFFF0, 0xFFFFFFFF, 0x0000000F},
  ...
  static Stream<Arguments> testI16() {
    return Helper.i16(new int[][] {
      ...
      {0xFFFFF000, 0xFFFFFFFF, 0x00000FFF},

      {0xFFFFFFFF, 0x00000000, 0xFFFFFFFF},
      {0xFFFFFFFF, 0x0000000F, 0xFFFFFFF0},
      {0xFFFFFFFF, 0xFFFFF000, 0x00000FFF},
      {0xFFFFFFFF, 0xFFFFFFFF, 0x00000000},
    });
  }
