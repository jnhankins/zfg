...
public final class EqlTest {

  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testBit")
  void testBit(final BitType a, final BitType b, final BitType e) { assertEquals(e, Eql.bit(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testU08")
  void testU08(final U08Type a, final U08Type b, final BitType e) { assertEquals(e, Eql.u08(a, b)); }
  static Stream<Arguments> testU08() {
    return Helper.u08rel(new int[][] {
      {0x00000000, 0x00000000, 1},
      {0x00000000, 0x0000000F, 0},
      {0x00000000, 0x000000F0, 0},
      {0x00000000, 0x000000FF, 0},

      {0x0000000F, 0x00000000, 0},
      {0x0000000F, 0x0000000F, 1},
      {0x0000000F, 0x000000F0, 0},
      {0x0000000F, 0x000000FF, 0},

      {0x000000F0, 0x00000000, 0},
      {0x000000F0, 0x0000000F, 0},
      {0x000000F0, 0x000000F0, 1},
      {0x000000F0, 0x000000FF, 0},

      {0x000000FF, 0x00000000, 0},
      {0x000000FF, 0x0000000F, 0},
      {0x000000FF, 0x000000F0, 0},
      {0x000000FF, 0x000000FF, 1},
    });
  }

  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testU16")
  void testU16(final U16Type a, final U16Type b, final BitType e) { assertEquals(e, Eql.u16(a, b)); }
  static Stream<Arguments> testU16() {
    return Helper.u16rel(new int[][] {
      {0x00000000, 0x00000000, 1},
      {0x00000000, 0x0000000F, 0},
      {0x00000000, 0x0000F000, 0},
      {0x00000000, 0x0000FFFF, 0},

      {0x0000000F, 0x00000000, 0},
      {0x0000000F, 0x0000000F, 1},
      {0x0000000F, 0x0000F000, 0},
      {0x0000000F, 0x0000FFFF, 0},

      {0x0000F000, 0x00000000, 0},
      {0x0000F000, 0x0000000F, 0},
      {0x0000F000, 0x0000F000, 1},
      {0x0000F000, 0x0000FFFF, 0},
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testU32")
  void testU32(final U32Type a, final U32Type b, final BitType e) { assertEquals(e, Eql.u32(a, b)); }
  static Stream<Arguments> testU32() {
    return Helper.u32rel(new int[][] {
      ...
      {0xF0000000, 0xF0000000, 1},
      {0xF0000000, 0xFFFFFFFF, 0},
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testU64")
  void testU64(final U64Type a, final U64Type b, final BitType e) { assertEquals(e, Eql.u64(a, b)); }
  static Stream<Arguments> testU64() {
    return Helper.u64rel(new long[][] {
      {0x00000000_00000000L, 0x00000000_00000000L, 1},
      {0x00000000_00000000L, 0x00000000_0000000FL, 0},
      ...
      {0x00000000_0000000FL, 0x00000000_0000000FL, 1},
      ...
      {0xF0000000_00000000L, 0xF0000000_00000000L, 1},
      {0xF0000000_00000000L, 0xFFFFFFFF_FFFFFFFFL, 0},
      ...
      {0xFFFFFFFF_FFFFFFFFL, 0xFFFFFFFF_FFFFFFFFL, 1},
    });
  }

  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testI08")
  void testI08(final I08Type a, final I08Type b, final BitType e) { assertEquals(e, Eql.i08(a, b)); }
  static Stream<Arguments> testI08() {
    return Helper.i08rel(new int[][] {
      ...
      {0xFFFFFFF0, 0x00000000, 0},
      {0xFFFFFFF0, 0x0000000F, 0},
      {0xFFFFFFF0, 0xFFFFFFF0, 1},
      {0xFFFFFFF0, 0xFFFFFFFF, 0},
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testI16")
  void testI16(final I16Type a, final I16Type b, final BitType e) { assertEquals(e, Eql.i16(a, b)); }
  static Stream<Arguments> testI16() {
    return Helper.i16rel(new int[][] {
      ...
      {0xFFFFF000, 0x00000000, 0},
      {0xFFFFF000, 0x0000000F, 0},
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testI32")
  void testI32(final I32Type a, final I32Type b, final BitType e) { assertEquals(e, Eql.i32(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testI64")
  void testI64(final I64Type a, final I64Type b, final BitType e) { assertEquals(e, Eql.i64(a, b)); }
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testF32")
  void testF32(final F32Type a, final F32Type b, final BitType e) { assertEquals(e, Eql.f32(a, b)); }
  static Stream<Arguments> testF32() {
    return Helper.f32rel(new float[][] {
      ...
      {+0.0f, -1.5f, 0},
      {+0.0f, +1.5f, 0},
      {+0.0f, Float.POSITIVE_INFINITY, 0},
      ...
      {+1.5f, -1.5f, 0},
      {+1.5f, +1.5f, 1},
      {+1.5f, Float.POSITIVE_INFINITY, 0},
      ...
      {Float.NEGATIVE_INFINITY, +0.0f, 0},
      {Float.NEGATIVE_INFINITY, -0.0f, 0},
      {Float.NEGATIVE_INFINITY, -1.5f, 0},
      {Float.NEGATIVE_INFINITY, +1.5f, 0},
  ...
  @ParameterizedTest(name = "{index}: {0} eql {1} = {2}") @MethodSource("testF64")
  void testF64(final F64Type a, final F64Type b, final BitType e) { assertEquals(e, Eql.f64(a, b)); }
  static Stream<Arguments> testF64() {
    return Helper.f64rel(new double[][] {
      ...
      {+1.5, -1.5, 0},
      {+1.5, +1.5, 1},
      {+1.5, Double.POSITIVE_INFINITY, 0},
      ...
      {Double.NEGATIVE_INFINITY, +0.0, 0},
      {Double.NEGATIVE_INFINITY, -0.0, 0},
      {Double.NEGATIVE_INFINITY, -1.5, 0},
      {Double.NEGATIVE_INFINITY, +1.5, 0},
