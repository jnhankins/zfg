...
public final class LtnTest {
  ...
  void testBit(final BitType a, final BitType b, final BitType e) { assertEquals(e, Ltn.bit(a, b)); }
  ...
  void testU08(final U08Type a, final U08Type b, final BitType e) { assertEquals(e, Ltn.u08(a, b)); }
  ...
  void testU16(final U16Type a, final U16Type b, final BitType e) { assertEquals(e, Ltn.u16(a, b)); }
  ...
  void testU32(final U32Type a, final U32Type b, final BitType e) { assertEquals(e, Ltn.u32(a, b)); }
  ...
  void testU64(final U64Type a, final U64Type b, final BitType e) { assertEquals(e, Ltn.u64(a, b)); }
  ...
  void testI08(final I08Type a, final I08Type b, final BitType e) { assertEquals(e, Ltn.i08(a, b)); }
  ...
  void testI16(final I16Type a, final I16Type b, final BitType e) { assertEquals(e, Ltn.i16(a, b)); }
  ...
  void testI32(final I32Type a, final I32Type b, final BitType e) { assertEquals(e, Ltn.i32(a, b)); }
  ...
  void testI64(final I64Type a, final I64Type b, final BitType e) { assertEquals(e, Ltn.i64(a, b)); }
  ...
  void testF32(final F32Type a, final F32Type b, final BitType e) { assertEquals(e, Ltn.f32(a, b)); }
  ...
  void testF64(final F64Type a, final F64Type b, final BitType e) { assertEquals(e, Ltn.f64(a, b)); }
