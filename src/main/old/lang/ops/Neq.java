...
public final class Neq {
  ...
  public static final int    u32(final int    a, final int    b) { return a != b ? 1 : 0; }
  public static final int    u64(final long   a, final long   b) { return a != b ? 1 : 0; }
  ...
  public static final BitType neq(final Val a, final Val b) { return ((I<Val>)a).neq(b); }
  public static interface I<T extends Val> { public BitType neq(final T that); }
}
