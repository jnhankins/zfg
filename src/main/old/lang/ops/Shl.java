...
public final class Shl {
  ...
  public static final int    u08(final int    a, final int    b) { return (a << (b & 0x7)) & 0x00FF; } // zero extend
  public static final int    u16(final int    a, final int    b) { return (a << (b & 0xF)) & 0xFFFF; } // zero extend
  public static final int    u32(final int    a, final int    b) { return a << b; }
  public static final long   u64(final long   a, final int    b) { return a << b; }
  public static final int    i08(final int    a, final int    b) { return (byte )(a << (b & 0x7)); }   // sign extend
  public static final int    i16(final int    a, final int    b) { return (short)(a << (b & 0xF)); }   // sign extend
  public static final int    i32(final int    a, final int    b) { return a << b; }
  public static final long   i64(final long   a, final int    b) { return a << b; }
  ...
  public static final Val shl(final Val a, final I32Type b) { return ((I<Val>)a).shl(b); }
  public static interface I<T extends Val> { public T shl(final I32Type that); }
}
