...
import zfg.old.parse.node.ConstExpr;
...
public class Parser {
  ...
  private boolean isZero(final Val val) {
    return switch (val) {
      case BitType v -> v.value == 0;
      case U08Type v -> v.value == 0;
      case U16Type v -> v.value == 0;
      case U32Type v -> v.value == 0;
      case U64Type v -> v.value == 0L;
      case I08Type v -> v.value == 0;
      case I16Type v -> v.value == 0;
      case I32Type v -> v.value == 0;
      case I64Type v -> v.value == 0L;
      case F32Type v -> v.value == 0.0f;
      case F64Type v -> v.value == 0.0d;
      default -> throw new AssertionError();
    };
  }
  ...
  private boolean isOne(final Val val) {
    return switch (val) {
      case BitType v -> v.value == 1;
      case U08Type v -> v.value == 1;
      case U16Type v -> v.value == 1;
      case U32Type v -> v.value == 1;
      case U64Type v -> v.value == 1L;
      case I08Type v -> v.value == 1;
      case I16Type v -> v.value == 1;
      case I32Type v -> v.value == 1;
      case I64Type v -> v.value == 1L;
      case F32Type v -> v.value == 1.0f;
      case F64Type v -> v.value == 1.0d;
      default -> throw new AssertionError();
    };
  }
  ...
  private boolean isNaN(final Val val) {
    return switch (val) {
      case F32Type v -> Float.isNaN(v.value);
      case F64Type v -> Double.isNaN(v.value);
      default -> false;
    };
  }
}
