...
public final class Div {
  private Div() {}
  public static interface I<T extends I<T>> { public T div(final T that); }
  public static final <T extends I<T>> T div(final T a, final T b) { return a.div(b); }
  ...
  public static final long   u64(final long   a, final long   b) { return Long.divideUnsigned(a, b); }
