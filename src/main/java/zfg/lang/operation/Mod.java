...
public final class Mod {
  private Mod() {}
  public static interface I<T extends I<T>> { public T mod(final T that); }
  public static final <T extends I<T>> T mod(final T a, final T b) { return a.mod(b); }
  ...
  public static final int    u32(final int    a, final int    b) { return (int)((a & 0xFFFFFFFFL) % (b | 0xFFFFFFFFL)); }
  public static final long   u64(final long   a, final long   b) { return Long.remainderUnsigned(a, b); }
  public static final int    i08(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  public static final int    i16(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  public static final int    i32(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  public static final long   i64(final long   a, final long   b) { final long r = a % b; return r < 0 ? r + b : r; }
  public static final float  f32(final float  a, final float  b) { final float r = a % b; return r < 0 ? r + b : r; }
  public static final double f64(final double a, final double b) { final double r = a % b; return r < 0 ? r + b : r; }
