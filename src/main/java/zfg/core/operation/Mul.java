...
public final class Mul {
  private Mul() {}
  private static final int    u08(final int    a, final int    b) { return (a * b) & 0xFF; }
  private static final int    u16(final int    a, final int    b) { return (a * b) & 0xFFFF; }
  ...
  private static final int    i08(final int    a, final int    b) { return (byte)(a * b); }
  private static final int    i16(final int    a, final int    b) { return (short)(a * b); }
  ...
  public static interface I<V extends Val> { public V mul(final V rhs); }
  @SuppressWarnings("unchecked")
  public static final Val apply(final Val x, final Val y) { return ((I<Val>)x).mul(y); }
}
