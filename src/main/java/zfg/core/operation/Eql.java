...
public final class Eql {
  ...
  private static final int    u32(final int    a, final int    b) { return a == b ? 1 : 0; }
  private static final int    u64(final long   a, final long   b) { return a == b ? 1 : 0; }
  ...
  public static interface I<V extends Val> { public Bit eql(final V rhs); }
}
