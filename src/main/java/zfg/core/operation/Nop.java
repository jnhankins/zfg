...
public final class Nop {
  private Nop() {}
  private static final int    bit(final int    a) { return a; }
  private static final int    u08(final int    a) { return a; }
  private static final int    u16(final int    a) { return a; }
  ...
  private static final int    bit(final int    a, final int    b) { return a; }
  private static final int    u08(final int    a, final int    b) { return a; }
  private static final int    u16(final int    a, final int    b) { return a; }
  private static final int    u32(final int    a, final int    b) { return a; }
  private static final long   u64(final long   a, final long   b) { return a; }
  private static final int    i08(final int    a, final int    b) { return a; }
  private static final int    i16(final int    a, final int    b) { return a; }
  private static final int    i32(final int    a, final int    b) { return a; }
  private static final long   i64(final long   a, final long   b) { return a; }
  private static final float  f32(final float  a, final float  b) { return a; }
  private static final double f64(final double a, final double b) { return a; }
