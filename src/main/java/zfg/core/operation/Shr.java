...
public final class Shr {
  ...
  private static final int    u08(final int    a, final int    b) { return a >>> (b & 0x7); } // zero extend
  private static final int    u16(final int    a, final int    b) { return a >>> (b & 0xF); } // zero extend
  private static final int    u32(final int    a, final int    b) { return a >>> b; }         // zero extend
  private static final long   u64(final long   a, final int    b) { return a >>> b; }         // zero extend
  private static final int    i08(final int    a, final int    b) { return a >> (b & 0x7); }  // sign extend
  private static final int    i16(final int    a, final int    b) { return a >> (b & 0xF); }  // sign extend
  private static final int    i32(final int    a, final int    b) { return a >> b; }          // sign extend
  private static final long   i64(final long   a, final int    b) { return a >> b; }          // sign extend
  ...
  public static interface I<V extends Val> { public V shr(final I32 rhs); }
}
