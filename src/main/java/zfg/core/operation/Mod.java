...
public final class Mod {
  ...
  private static final int    i08(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  private static final int    i16(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  private static final int    i32(final int    a, final int    b) { final int r = a % b; return r < 0 ? r + b : r; }
  private static final long   i64(final long   a, final long   b) { final long r = a % b; return r < 0 ? r + b : r; }
  private static final float  f32(final float  a, final float  b) { final float r = a % b; return r < 0 ? r + b : r; }
  private static final double f64(final double a, final double b) { final double r = a % b; return r < 0 ? r + b : r; }
